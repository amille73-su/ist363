...
// NEW: modularize our search  -> takes a callback hanlder as a prop
const Search = ({ onSearch }) => (
  <div>
    <label htmlFor="search">Search: </label>
    {/* onSearch prop is the passed functino to handle the change */}
...
function App() {
  ...
  return (
  <div>
    {/* NEW: pass the handler function down to Search component as a props */}
